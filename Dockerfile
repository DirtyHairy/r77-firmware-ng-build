...
RUN apt-get install -y git screen vim wget file man u-boot-tools device-tree-compiler build-essential cpio autoconf autogen automake sudo ncurses-dev python libtool qemu-user dosfstools
